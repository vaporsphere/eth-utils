...
You can set an alternative key directory to use to find your vapory encrypted keyfile.

Note:
As you can directly copy your encrypted accounts to another vapory instance,
